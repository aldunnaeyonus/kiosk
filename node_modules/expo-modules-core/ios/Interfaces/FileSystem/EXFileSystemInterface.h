...
@property (nonatomic, readonly) NSString * _Nullable documentDirectory;
...
- (nonnull NSString *)generatePathInDirectory:(NSString *_Nullable)directory withExtension:(NSString *_Nullable)extension;
- (BOOL)ensureDirExistsWithPath:(NSString *_Nullable)path;
